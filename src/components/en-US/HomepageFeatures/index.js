...
const FeatureList = [
  {
    ...
    description: (
      <>
        Go-Sail is very easy to use. Help developers to build services in the simplest and most reliable way.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Go-Sail allows developers to focus only on their own business logic and ignore other chores.
      </>
    ),
  },
  {
